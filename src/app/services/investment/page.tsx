...
export default function InvestmentPublicPage() {
  ...
  // --- বিনিয়োগ আইটেম ডাটাবেজ (আইকনে সাইজ যুক্ত করা হয়েছে) ---
  const investmentItems = [
    // ১. কৃষি ও খামার
    { title: "হাঁস-মুরগি ও ছাগল পালন", category: "কৃষি ও খামার", icon: <Sprout size={28}/>, desc: "পারিবারিক পর্যায়ে পালনের জন্য স্বল্প পুঁজি বিনিয়োগ।" },
    { title: "দুগ্ধ খামার / গাভী পালন", category: "কৃষি ও খামার", icon: <Milk size={28}/>, desc: "উন্নত জাতের গাভী ক্রয় এবং লালন-পালনের সুবিধা।" },
    { title: "গরু মোটাতাজাকরণ", category: "কৃষি ও খামার", icon: <Sprout size={28}/>, desc: "কোরবানি ঈদ বা সিজনাল প্রজেক্টের জন্য গরু ক্রয়।" },
    { title: "মাছ চাষ প্রজেক্ট", category: "কৃষি ও খামার", icon: <Fish size={28}/>, desc: "পুকুর লিজ নেওয়া বা বায়োফ্লক মাছ চাষের সরঞ্জাম।" },
    
    // ২. ক্ষুদ্র ব্যবসা
    { title: "মুদি দোকান সম্প্রসারণ", category: "ক্ষুদ্র ব্যবসা", icon: <Store size={28}/>, desc: "দোকানে মাল তোলার জন্য পণ্য-ভিত্তিক পুঁজি সহায়তা।" },
    { title: "ফেরিওয়ালা বা হকার", category: "ক্ষুদ্র ব্যবসা", icon: <ShoppingBag size={28}/>, desc: "ভ্যানে বা পায়ে হেঁটে পণ্য বিক্রির মালামাল ক্রয়।" },
    { title: "মিনি গার্মেন্টস/সেলাই", category: "ক্ষুদ্র ব্যবসা", icon: <Shirt size={28}/>, desc: "নারীদের জন্য সেলাই মেশিন বা ছোট গার্মেন্টস মেশিনারি।" },
    
    // ৩. যানবাহন
    { title: "অটো ভ্যান বা রিক্সা", category: "যানবাহন", icon: <Car size={28}/>, desc: "পণ্য বা যাত্রী পরিবহনের জন্য নতুন ভ্যান বা রিক্সা।" },
    { title: "ইলেকট্রিক অটো/ইজি বাইক", category: "যানবাহন", icon: <Car size={28}/>, desc: "ব্যাটারি চালিত ইজি বাইক ক্রয়ের পূর্ণাঙ্গ সুবিধা।" },
    
    // ৪. প্রযুক্তি
    { title: "কম্পিউটার ও আইটি সেন্টার", category: "প্রযুক্তি ও দক্ষতা", icon: <Laptop size={28}/>, desc: "কম্পিউটার, প্রিন্টার ও ফটোকপি মেশিন ক্রয়।" },
    { title: "মোবাইল সার্ভিসিং ল্যাব", category: "প্রযুক্তি ও দক্ষতা", icon: <Smartphone size={28}/>, desc: "মোবাইল মেরামতের আধুনিক যন্ত্রপাতি ও হটগান।" },
    
    // ৫. গৃহ
    { title: "টিনের ঘর তৈরি", category: "গৃহ ও অন্যান্য", icon: <Home size={28}/>, desc: "বসতঘর নির্মাণ বা মেরামতের জন্য ঢেউটিন ও খুঁটি।" },
    { title: "স্যানিটেশন ও টিউবওয়েল", category: "গৃহ ও অন্যান্য", icon: <Hammer size={28}/>, desc: "স্বাস্থ্যসম্মত ল্যাট্রিন স্থাপন ও বিশুদ্ধ পানির টিউবওয়েল।" },
  ];
